...
public class D09_Dropdown {
    ...
    public void dropdownTesti() {
        ...
        //2.Adim Select object'i olusturalim ve locat ettigimiz Webelementi parametre olarak objeye ekledik

        Select select=new Select(dropDown);

        //3.Adim var olan 3 yontemden herhangi biri ile istedigimiz kategoriyi secelim
    ...
    public  void test02(){
        ...
        //Sectigimiz option'in "Option 2" oldugunu test edin.
