...
public class D16_Faker extends TestBase {
    ...
    public void facebookUserTest() throws InterruptedException {
        ...
        //Cinsiyeti secin
        WebElement maleRadioButton=driver.findElement(By.xpath("(//input[@class='_8esa'])[2]"));
        if (!maleRadioButton.isSelected()){
            maleRadioButton.click();

        }
        Assert.assertTrue(maleRadioButton.isSelected());
        System.out.println("Male secili");
        //Isaretlediginiz cinsiyetin secili, diger cinsiyet kutusunun secili olmadigini test edin.
        WebElement famaleRadio=driver.findElement(By.xpath("(//input[@class='_8esa'])[1]"));
        WebElement customRadio=driver.findElement(By.xpath("(//input[@class='_8esa'])[3]"));
        Assert.assertTrue(!famaleRadio.isSelected());
        System.out.println("Famele secili degil");
        Assert.assertTrue(!customRadio.isSelected());
        System.out.println("Custom secili degil");
